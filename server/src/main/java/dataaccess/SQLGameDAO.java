...
public class SQLGameDAO implements GameDAO{
  ...
  public void updateGame(String gameID, GameData updatedGame) throws DataAccessException {
    try (Connection conn = DatabaseManager.getConnection();
      ...
      statement.setString(1, updatedGame.getWhite());
      statement.setString(2, updatedGame.getBlack());
      statement.setString(3, updatedGame.getName());
      statement.setString(4, serializeGame(updatedGame.getGame()));
